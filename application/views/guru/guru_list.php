        ...
        <div class="col-12" style="margin-top:2px ">
          <div class="card">
            <div class="card-header">
              ...
              <h3 class='box-title'>Guru <?php echo anchor('guru/create/','Tambah Data',array('class'=>'btn btn-danger btn-sm'));?>
            ...
            <div class="card-body">
              ...
              <div class="input-group d-flex justify-content-end" style="padding-bottom: 2px">
                  ...
                  <input type="text" class="form-control col-lg-2" placeholder="Guru" name="cari" value="<?php echo $this->session->flashdata('pag')?>">
              ...
              <table  class="table table-bordered table-striped">
                ...
                foreach ($guru_data->result() as $guru)
                {
                ?>
                <tr>
                  ...
                  <td style="text-align:center" width="140px">
                    <?php
                    echo anchor(site_url('guru/read/'.$guru->idguru),'<i class="fa fa-eye"></i>',array('title'=>'detail','class'=>'btn btn-primary btn-sm'));
                    echo '  ';
                    echo anchor(site_url('guru/update/'.$guru->idguru),'<i class="fa fa-edit"></i>',array('title'=>'edit','class'=>'btn btn-warning btn-sm'));
                    echo '  ';
                    echo anchor(site_url('guru/delete/'.$guru->idguru),'<i class="fa fa-trash"></i>','title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
                    ?>
                  </td>
                </tr>
                <?php
